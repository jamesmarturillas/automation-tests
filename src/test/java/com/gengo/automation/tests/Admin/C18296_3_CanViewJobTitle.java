 ...
 */
public class C18296_3_CanViewJobTitle extends AutomationBase {

    private String jobID, source, target, dateCreated, status, level;

    public C18296_3_CanViewJobTitle() throws IOException {}
     ...
     * goes to the Jobs Page, filters by Reviewable, and checks the first entry
    ...
    public void adminCheckTitle(){
        ...
        adminJobsPage.selectStatusFilter(FILTER_REVIEWABLE);
        ...
        assertTrue(FILTER_REVIEWABLE.contains(status));
