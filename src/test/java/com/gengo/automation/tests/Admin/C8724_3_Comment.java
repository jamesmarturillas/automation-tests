...
/**
 * @case Comment
 * Word to Character, Stripe Payment, Standard Tier, Multiple Jobs
 * @reference https://gengo.testrail.com/index.php?/cases/view/8724
 */
public class C8724_3_Comment extends AutomationBase {
    ...
    public C8724_3_Comment() throws IOException {}
    ...
    public void checkEmail() {
        ...
        assertTrue(gmailInboxPage.checkNewComment(jobNo[0]));
