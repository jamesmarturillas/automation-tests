 ...
 * Filter Held for Resolution Jobs
 * @reference https://gengo.testrail.com/index.php?/cases/view/18296
 */
public class C18296_6_CanViewJobTitle extends AutomationBase {

    private String jobID, source, target, dateCreated, status, level;

    public C18296_6_CanViewJobTitle() throws IOException {}
     ...
     * goes to the Jobs Page, filters by Held for Resolution, and checks the first entry
    ...
    public void adminCheckTitle(){
        ...
        // Filter by Held for Resolution
        adminJobsPage.selectStatusFilter(FILTER_HELD_FOR_RESOLUTION);
        ...
        assertTrue(FILTER_HELD_FOR_RESOLUTION.contains(status));
