 ...
 */
public class C18296_1_CanViewJobTitle extends AutomationBase {

    private String jobID, source, target, dateCreated, status, level;

    public C18296_1_CanViewJobTitle() throws IOException {}
     ...
     * goes to the Jobs Page, filters by Available, and checks the first entry
    ...
    public void adminCheckTitle(){
        ...
        assertTrue(FILTER_AVAILABLE.contains(status));
