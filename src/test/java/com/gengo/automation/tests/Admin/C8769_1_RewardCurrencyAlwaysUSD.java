 ...
 * Translator Account with 0 Rewards
 * @reference https://gengo.testrail.com/index.php?/cases/view/8769
 */
public class C8769_1_RewardCurrencyAlwaysUSD extends AutomationBase {

    public C8769_1_RewardCurrencyAlwaysUSD() throws IOException {}
    ...
    public void adminCheckRewards(){
        ...
        // Click the First Translator with Zero Rewards
        adminUsersPage.viewFirstTranslatorZeroRewards();

        // Check if the Rewards Section shows no Reward
        assertTrue(adminUserPage.getRewardsAmt().getText().equals("-"));
