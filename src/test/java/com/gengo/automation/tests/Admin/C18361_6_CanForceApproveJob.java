 ...
 */
public class C18361_6_CanForceApproveJob extends AutomationBase {

    private String jobID, source, target, dateCreated, status, level;

    public C18361_6_CanForceApproveJob() throws IOException {}
     ...
     * goes to the Jobs Page, filters by Cancelled, and checks the first entry
    ...
    public void adminCheckTitle(){
        ...
        // Filter by Cancelled
        adminJobsPage.selectStatusFilter(FILTER_CANCELLED);
        ...
        assertTrue(FILTER_CANCELLED.contains(status));
