 ...
 */
public class C18349_2_CancelJobs extends AutomationBase {

    private String parentWindow, excerpt, jobURL;
    private String[] itemToTranslate;
    private String[] excerpts, unitCount, jobNo = new String[3];
    ...
    public C18349_2_CancelJobs() throws IOException {}
    ...
    public void adminCancelJob(){
        ...
        // Cancel jobs and recheck the status
