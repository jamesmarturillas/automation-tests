 ...
 */
public class C18361_7_CanForceApproveJob extends AutomationBase {

    private String jobID, source, target, dateCreated, status, level;

    public C18361_7_CanForceApproveJob() throws IOException {}
     ...
     * goes to the Jobs Page, filters by Revising, and checks the first entry
