 ...
 * Word to Character, Credits Payment, Standard Tier, Single Job - Unavailable
 * @reference https://gengo.testrail.com/index.php?/cases/view/18359
 */
public class C18359_3_CancelAvailableGroupedOrders extends AutomationBase {
    ...
    public C18359_3_CancelAvailableGroupedOrders() throws IOException {}
    ...
    public void adminCancelJob(){
        ...
        // Cancel order and recheck the status
    ...
    public void pickUpByTranslatorAgain(){
        ...
        workbenchPage.translateTextArea(itemToTranslate[0]);
    ...
    public void checkEmail() {
        ...
        assertTrue(gmailInboxPage.checkJobForReview(jobNo.substring(1)));
        assertTrue(gmailInboxPage.checkJobApproved(jobNo.substring(1)));
    }
}
