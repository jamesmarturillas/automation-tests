 ...
 */
public class C18361_8_CanForceApproveJob extends AutomationBase {

    private String jobID, source, target, dateCreated, status, level;

    public C18361_8_CanForceApproveJob() throws IOException {}
     ...
     * goes to the Jobs Page, filters by Returned, and checks the first entry
