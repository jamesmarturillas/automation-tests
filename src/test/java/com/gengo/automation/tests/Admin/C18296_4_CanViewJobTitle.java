 ...
 */
public class C18296_4_CanViewJobTitle extends AutomationBase {

    private String jobID, source, target, dateCreated, status, level;

    public C18296_4_CanViewJobTitle() throws IOException {}
     ...
     * goes to the Jobs Page, filters by Approved, and checks the first entry
    ...
    public void adminCheckTitle(){
        ...
        // Filter by Approved
        adminJobsPage.selectStatusFilter(FILTER_APPROVED);
        ...
        assertTrue(FILTER_APPROVED.contains(status));
