 ...
 */
public class C18296_2_CanViewJobTitle extends AutomationBase {

    private String jobID, source, target, status, level;

    public C18296_2_CanViewJobTitle() throws IOException {}
     ...
     * goes to the Jobs Page, filters by Incomplete, and checks the first entry
    ...
    public void adminCheckTitle(){
        ...
        adminJobsPage.selectStatusFilter(FILTER_INCOMPLETE);
        ...
        assertTrue(FILTER_INCOMPLETE.contains(status));
