...
/**
 * @case Can View Job Title
 * Filter Rejected and Cancelled Jobs
 * @reference https://gengo.testrail.com/index.php?/cases/view/18296
 */
public class C18296_7_CanViewJobTitle extends AutomationBase {

    private String jobID, source, target, dateCreated, status, level;

    public C18296_7_CanViewJobTitle() throws IOException {}
     ...
     * goes to the Jobs Page, filters by Rejected and Cancelled, and checks the first entry
    ...
    public void adminCheckTitle(){
        ...
        // Filter by Rejected and Cancelled
        adminJobsPage.selectStatusFilter(FILTER_REJECTED_CANCELLED);
        ...
        assertTrue(FILTER_REJECTED_CANCELLED.contains(status));
