 ...
 * Filter Returned for Edits Jobs
 * @reference https://gengo.testrail.com/index.php?/cases/view/18296
 */
public class C18296_5_CanViewJobTitle extends AutomationBase {

    private String jobID, source, target, dateCreated, status, level;

    public C18296_5_CanViewJobTitle() throws IOException {}
     ...
     * goes to the Jobs Page, filters by Returned For Edits, and checks the first entry
    ...
    public void adminCheckTitle(){
        ...
        // Filter by Returned For Edits
        adminJobsPage.selectStatusFilter(FILTER_RETURNED_FOR_EDITS);
        ...
        assertTrue(FILTER_RETURNED_FOR_EDITS.contains(status));
