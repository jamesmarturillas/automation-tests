 ...
 */
public class SeeScoreInConfirmationScreen_TID146507205_1 extends AutomationBase {

    public SeeScoreInConfirmationScreen_TID146507205_1() throws IOException {}

    @Test
    public void perfectScoreCheck() {
        ...
        // Reserved Filter if user is contractor
        adminChecksPage.filterChecksSource("english");
        adminChecksPage.filterChecksTarget("japanese");
    ...
    @Test (dependsOnMethods = "perfectScoreCheck")
    public void editCheckDisplayScore() {
        pluginPage.passThisPage();
        assertTrue(homePage.getSignIn().isDisplayed(),
                var.getElementNotFoundErrMsg());
        ...
        // Filter checks to complete status
        adminChecksPage.filterChecksStatus("complete");
        ...
        // Go to Actions > Edit
        adminChecksPage.editGoCheckPage();
        assertTrue(global.getPageTitle().isDisplayed(),
                var.getElementIsNotDisplayedErrMsg());
        assertTrue(page.getCurrentUrl().contains("gocheck."),
                var.getWrongUrlErrMsg());

        // Click Submit for existing score
        goCheckPage.clickSubmitGocheck();
        assertTrue(goCheckPage.getSubmitConfirmationModal().isDisplayed());
        assertTrue(goCheckPage.getScoreDisplayConfirmationModal().isDisplayed());
