...
/**
 * @case Change Layout - (Character to Character, Stripe Payment, Business Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/235
 */
public class C235_7_ChangeLayout extends AutomationBase{
    ...
    public void initFields() throws IOException{
        ...
        translatedText1 = var.getTranslatedItem(24);
        unitCount = new String[] { var.getUnitCountSource(24) };
    }

    public C235_7_ChangeLayout() throws IOException {}
