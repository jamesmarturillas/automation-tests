...
/**
 * @case Glossary Triple Brackets And HTML Tag Suggestion - (Character to Word, Stripe Payment, Business Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/250
 */
public class C250_2_GlossaryTripleBracketsAndHTMLSuggestion extends AutomationBase {
    ...
    public void initFields() throws IOException{
        ...
        translatedText = var.getTranslatedItem(22);
        unitCount = new String[] { var.getUnitCountSource(22) };
    }

    public C250_2_GlossaryTripleBracketsAndHTMLSuggestion() throws IOException {}
