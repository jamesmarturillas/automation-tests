 ...
 */
public class C8756_4_GlossaryWithTermsInBrackets extends AutomationBase {
    ...
    public C8756_4_GlossaryWithTermsInBrackets() throws IOException {}
    ...
    public void uploadInvalidGlossary() throws IOException {
        ...
        glossaryPage.uploadInvalidGlossary(var.getJaToZhBracketedGlossary());
    ...
    public void checkGlossaryOnOrderPage() throws IOException {
        ...
        assertFalse(customerCheckoutPage.isGlossaryPresent(var.getJaToZhBracketedGlossary().replace(".csv", "")));
