...
/**
 * @case Right Panel Information - (Character to Word, Stripe Payment, Business Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/249
 */
public class C249_RightPanelInformation extends AutomationBase {
    ...
    public C249_RightPanelInformation() throws IOException {}
