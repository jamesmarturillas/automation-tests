...
/**
 * @case Status Filter - (Word to Word, Stripe Payment, Standard Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/236
 */
public class C236_3_StatusFilter extends AutomationBase{
    ...
    public void initFields() throws IOException{
        ...
        translatedText2 = var.getTranslatedItem(23);
        unitCount = new String[] { var.getUnitCountSource(23) };
    }

    public C236_3_StatusFilter() throws IOException {}
