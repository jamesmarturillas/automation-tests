...
/**
 * @case Glossary Triple Brackets And HTML Tag Suggestion - (Word to Word, Stripe Payment, Standard Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/250
 */
public class C250_3_GlossaryTripleBracketsAndHTMLSuggestion extends AutomationBase {

    private String parentWindow, orderNo, jobNo;
    private String translatedText, excerpt;
    private String[] unitCount,itemToTranslate,
            glossaryTexts = {"Gengo","test","record"}, // contains the glossary source texts
            glossaryMatches = {"Lenggwahe","Pagsusulit","Ilagda"}, // contains the glossary target texts
    ...
    public void initFields() throws IOException{
        ...
        translatedText = var.getTranslatedItem(23);
        unitCount = new String[] { var.getUnitCountSource(23) };
    }

    public C250_3_GlossaryTripleBracketsAndHTMLSuggestion() throws IOException {}
    ...
    public void translatorPickUpJob() {
        ...
        workbenchPage.translateTextArea(" ");
        ...
        workbenchPage.addGlossaryToText(highlightGlossary, glossaryTexts);
