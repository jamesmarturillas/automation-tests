...
/**
 * @case Comment R/W and Flag Job - (Word to Word, Paypal Payment, Business Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/234
 */
public class C234_5_CommentRWAndFlag extends AutomationBase {
    ...
    public void initFields() throws IOException{
        ...
        translatedText1 = var.getTranslatedItem(19).substring(0, 20);
        translatedText2 = var.getTranslatedItem(19);
        unitCount = new String[] { var.getUnitCountSource(19) };
    }

    public C234_5_CommentRWAndFlag() throws IOException {}
