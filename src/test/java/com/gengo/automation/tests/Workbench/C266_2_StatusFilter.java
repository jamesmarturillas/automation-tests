...
/**
 * @case Status Filter - (Character to Word, Stripe Payment, Business Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/266
 */
public class C266_2_StatusFilter extends AutomationBase{
    ...
    public C266_2_StatusFilter() throws IOException {}
