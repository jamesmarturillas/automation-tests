...
/**
 * @case Glossary Triple Brackets And HTML Tag Suggestion - (Character to Character, Paypal Payment, Standard Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/250
 */
public class C250_4_GlossaryTripleBracketsAndHTMLSuggestion extends AutomationBase {
    ...
    public void initFields() throws IOException{
        ...
        translatedText = var.getTranslatedItem(24);
        unitCount = new String[] { var.getUnitCountSource(24) };
    }

    public C250_4_GlossaryTripleBracketsAndHTMLSuggestion() throws IOException {}
