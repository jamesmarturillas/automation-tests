 ...
 */
public class C8756_3_GlossaryWithTermsInBrackets extends AutomationBase {
    ...
    public C8756_3_GlossaryWithTermsInBrackets() throws IOException {}
    ...
    public void uploadInvalidGlossary() throws IOException {
        ...
        glossaryPage.uploadInvalidGlossary(var.getEnToTlBracketedGlossary());
    ...
    public void checkGlossaryOnOrderPage() throws IOException {
        ...
        assertFalse(customerCheckoutPage.isGlossaryPresent(var.getEnToTlBracketedGlossary().replace(".csv", "")));
