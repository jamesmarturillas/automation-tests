 ...
 * @reference https://gengo.testrail.com/index.php?/cases/view/283
 */
public class C283_CheckHighlights extends AutomationBase {
    ...
    public C283_CheckHighlights() throws IOException {}
