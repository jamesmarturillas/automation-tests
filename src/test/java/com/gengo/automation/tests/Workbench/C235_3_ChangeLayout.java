...
/**
 * @case Change Layout - (Character to Word, Stripe Payment, Standard Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/235
 */
public class C235_3_ChangeLayout extends AutomationBase{
    ...
    public void initFields() throws IOException{
        ...
        translatedText1 = var.getTranslatedItem(22);
        unitCount = new String[] { var.getUnitCountSource(22) };
    }

    public C235_3_ChangeLayout() throws IOException {}
