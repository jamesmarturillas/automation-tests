...
/**
 * @case Change Layout - (Word to Character, Paypal Payment, Business Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/235
 */
public class C235_1_ChangeLayout extends AutomationBase{
    ...
    public void initFields() throws IOException{
        ...
        translatedText1 = var.getTranslatedItem(21);
        unitCount = new String[] { var.getUnitCountSource(21) };
    }

    public C235_1_ChangeLayout() throws IOException {}
