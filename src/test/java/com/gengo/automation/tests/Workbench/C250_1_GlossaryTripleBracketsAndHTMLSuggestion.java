...
/**
 * @case Glossary Triple Brackets And HTML Tag Suggestion - (Word to Character, Paypal Payment, Business Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/250
 */
public class C250_1_GlossaryTripleBracketsAndHTMLSuggestion extends AutomationBase {
    ...
    public void initFields() throws IOException{
        ...
        translatedText = var.getTranslatedItem(21);
        unitCount = new String[] { var.getUnitCountSource(21) };
    }

    public C250_1_GlossaryTripleBracketsAndHTMLSuggestion() throws IOException {}
