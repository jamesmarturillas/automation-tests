...
/**
 * @case Comment R/W and Flag Job - (Character to Character, Stripe Payment, Business Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/234
 */
public class C234_7_CommentRWAndFlag extends AutomationBase {
    ...
    public void initFields() throws IOException {
        ...
        itemToTranslate = new String[] {
                var.getItemToTranslate(20)
        };
        // Only a portion of the translated text is stored on translatedText1
        translatedText1 = var.getTranslatedItem(20).substring(0, 20);
        translatedText2 = var.getTranslatedItem(20);
        unitCount = new String[] { var.getUnitCountSource(20) };
    }

    public C234_7_CommentRWAndFlag() throws IOException {}
