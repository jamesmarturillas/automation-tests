...
/**
 * @case Status Filter - (Word to Character, Paypal Payment, Business Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/266
 */
public class C266_1_StatusFilter extends AutomationBase{
    ...
    public C266_1_StatusFilter() throws IOException {}
    ...
    public void translatorRevise() {
        ...
        workbenchPage.clickInactiveText();
        workbenchPage.translateTextArea(translatedItemRevised, excerpts, translatedItemRevised.length);
        ...
        assertTrue(workbenchPage.isUnsubmittedVisible(), var.getElementIsNotDisplayedErrMsg());
        assertFalse(workbenchPage.isSubmittedDisabledVisible(), var.getElementIsNotDisplayedErrMsg());
        assertFalse(workbenchPage.isRevisingDisabledVisible(), var.getElementIsNotDisplayedErrMsg());
        assertTrue(workbenchPage.isErrorDisabledVisible(), var.getElementIsNotDisplayedErrMsg());
        ...
        assertFalse(workbenchPage.isJobFilteredVisible(excerpts[1]));
        assertFalse(workbenchPage.isJobFilteredVisible(excerpts[2]));
        ...
        workbenchPage.filterSubmitted();
        assertTrue(workbenchPage.isFilterSelected());
        assertFalse(workbenchPage.isJobFilteredVisible(excerpt));
        assertTrue(workbenchPage.isJobFilteredVisible(excerpts[1]));
        assertTrue(workbenchPage.isJobFilteredVisible(excerpts[2]));

        // Filter Revising
        workbenchPage.openFilterDropDown();
        workbenchPage.filterRevising();
        assertTrue(workbenchPage.isFilterSelected());
        assertTrue(workbenchPage.isFilterSelected());
        assertTrue(workbenchPage.isJobFilteredVisible(excerpt));
        assertFalse(workbenchPage.isJobFilteredVisible(excerpts[1]));
