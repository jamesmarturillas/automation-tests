...
/**
 * @case Make translations of group job by a couple of translators -
 * (Word to Character, Stripe Payment, Standard Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/275
 */
public class C275_TwoTranslatorOnAGroupedJob extends AutomationBase {
    ...
    public C275_TwoTranslatorOnAGroupedJob() throws IOException {}
