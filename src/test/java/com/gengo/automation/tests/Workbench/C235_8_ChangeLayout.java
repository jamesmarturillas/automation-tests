...
/**
 * @case Change Layout - (Character to Character, Paypal Payment, Standard Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/235
 */
public class C235_8_ChangeLayout extends AutomationBase{
    ...
    public C235_8_ChangeLayout() throws IOException {}
