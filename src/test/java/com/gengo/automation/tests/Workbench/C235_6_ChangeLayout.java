...
/**
 * @case Change Layout - (Word to Word, Stripe Payment, Standard Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/235
 */
public class C235_6_ChangeLayout extends AutomationBase{
    ...
    public C235_6_ChangeLayout() throws IOException {}
