 ...
 */
public class C8756_1_GlossaryWithTermsInBrackets extends AutomationBase {
    ...
    public C8756_1_GlossaryWithTermsInBrackets() throws IOException {}
    ...
    public void uploadInvalidGlossary() throws IOException {
        ...
        glossaryPage.uploadInvalidGlossary(var.getEnToJaBracketedGlossary());
    ...
    public void checkGlossaryOnOrderPage() throws IOException {
        ...
        assertFalse(customerCheckoutPage.isGlossaryPresent(var.getEnToJaBracketedGlossary().replace(".csv", "")));
