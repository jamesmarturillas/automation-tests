...
/**
 * @case Comment R/W and Flag Job - (Character to Character, Paypal Payment, Standard Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/234
 */
public class C234_8_CommentRWAndFlag extends AutomationBase {
    ...
    public C234_8_CommentRWAndFlag() throws IOException {}
