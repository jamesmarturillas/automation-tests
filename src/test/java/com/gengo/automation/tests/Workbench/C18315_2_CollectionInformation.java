...
/**
 * @case Collection Information - (Character to Word, Paypal Payment, Business Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/18315
 */
public class C18315_2_CollectionInformation extends AutomationBase{
    ...
    public C18315_2_CollectionInformation() throws IOException {}
    ...
    public void translatorOpenJob() throws AWTException {
        ...
        assertEquals(workbenchPage.getLanguagePairTxt().getText(), "jaen", var.getTextNotEqualErrMsg());
    }
