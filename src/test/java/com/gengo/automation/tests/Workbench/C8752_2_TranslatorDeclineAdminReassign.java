 ...
 * (Word to Character, Stripe Payment, Standard Tier, Grouped Job) - decline using default reason
 * @reference https://gengo.testrail.com/index.php?/cases/view/8752
 */
public class C8752_2_TranslatorDeclineAdminReassign extends AutomationBase {

    private String parentWindow, orderNo, excerpt, collectionId;
    ...
    public C8752_2_TranslatorDeclineAdminReassign() throws IOException {}
     ...
     * and checks if the emails for order received, and
