...
/**
 * @case Change Layout - (Word to Word, Paypal Payment, Business Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/235
 */
public class C235_5_ChangeLayout extends AutomationBase{
    ...
    public C235_5_ChangeLayout() throws IOException {}
