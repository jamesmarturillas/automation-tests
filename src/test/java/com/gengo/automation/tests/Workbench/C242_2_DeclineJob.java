...
/**
 * @case Decline Job - (Word to Character, Stripe Payment, Standard Tier) - decline not using the default reason
 * @reference https://gengo.testrail.com/index.php?/cases/view/242
 */
public class C242_2_DeclineJob extends AutomationBase {
    ...
    public C242_2_DeclineJob() throws IOException {}
    ...
    public void pickUpAndDeclineByTranslator(){
        ...
        workbenchPage.declineJob("context", "Collection has issues");
