...
/**
 * @case Collection Information - (Word to Word, Paypal Payment, Standard Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/18315
 */
public class C18315_3_CollectionInformation extends AutomationBase{
    ...
    public C18315_3_CollectionInformation() throws IOException {}
    ...
    public void translatorOpenJob() throws AWTException {
        ...
        assertEquals(workbenchPage.getLanguagePairTxt().getText(), "entl", var.getTextNotEqualErrMsg());
    }
