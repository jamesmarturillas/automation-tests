...
/**
 * @case Glossary Triple Brackets And HTML Tag Suggestion - (Character to Word, Paypal Payment, Business Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/280
 */
public class C280_4_GlossaryTripleBracketsAndHTMLSuggestion extends AutomationBase {
    ...
    private String[] unitCount,itemToTranslate, excerpts, translatedItem, jobNo = new String[3],
            ...
            glossaryMatches2 = {"test","Gengo","record"}, // contains the glossary target texts
            glossaryMatches3 = {"test","record","Gengo"}, // contains the glossary target texts
    ...
    public C280_4_GlossaryTripleBracketsAndHTMLSuggestion() throws IOException {}
