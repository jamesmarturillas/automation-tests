 ...
 * @reference https://gengo.testrail.com/index.php?/cases/view/279
 */
public class C279_RightPanelInformation extends AutomationBase {
    ...
    public C279_RightPanelInformation() throws IOException {}
