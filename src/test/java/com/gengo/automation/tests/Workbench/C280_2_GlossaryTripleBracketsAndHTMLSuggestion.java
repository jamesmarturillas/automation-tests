...
/**
 * @case Glossary Triple Brackets And HTML Tag Suggestion - (Word to Word, Paypal Payment, Business Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/280
 */
public class C280_2_GlossaryTripleBracketsAndHTMLSuggestion extends AutomationBase {
    ...
    public C280_2_GlossaryTripleBracketsAndHTMLSuggestion() throws IOException {}
