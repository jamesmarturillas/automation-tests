...
/**
 * @case Comment R/W and Flag Job - (Word to Word, Stripe Payment, Standard Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/234
 */
public class C234_6_CommentRWAndFlag extends AutomationBase {
    ...
    public C234_6_CommentRWAndFlag() throws IOException {}
