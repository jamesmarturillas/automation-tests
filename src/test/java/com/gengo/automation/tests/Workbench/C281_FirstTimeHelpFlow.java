...
/**
 * @case First Time Help Flow - (Word to Character, Paypal Payment, Business Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/281
 */
public class C281_FirstTimeHelpFlow extends AutomationBase{
    private String parentWindow, orderNo ;
    private String[] itemToTranslate, excerpts, translatedItem, jobNo = new String[5];
    private String newExcerpt, excerpt;
    private String[] unitCount;

    @BeforeClass
    public void initFields() throws IOException{
        excerpt = var.getExcerptEnglish(17);
        newExcerpt = var.getExcerptEnglish(17);
        excerpts = new String[] {
    ...
    public C281_FirstTimeHelpFlow() throws IOException {}
    ...
    /**
     * translatorOpenJob --- a method wherein the translator opens the job workbench and checks
     * for the workbench modal and its pages
     * */
    @Test(dependsOnMethods = "translatorFindJob")
    public void translatorOpenJob() throws AWTException {
        // Check each page on the modal shown
        assertTrue(workbenchPage.checkFirstTimeHelpFlow());
    ...
    /**
     * translatorSubmit --- this method has the translator open another
     * job for translation and check if the workbench modal is on the page or not
     * */
    @Test(dependsOnMethods = "translatorAddTranslatedText")
    public void translatorFindAnotherJob() throws AWTException {
        ...
        // Check that the workbench modal is not visible 
        assertFalse(workbenchPage.isWorkbenchModalVisible());
     ...
     * */
    @Test(dependsOnMethods = "translatorFindAnotherJob")
