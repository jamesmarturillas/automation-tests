...
/**
 * @case Comment R/W and Flag Job - (Word to Character, Paypal Payment, Business Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/234
 */
public class C234_1_CommentRWAndFlag extends AutomationBase {
    ...
    public C234_1_CommentRWAndFlag() throws IOException {}
