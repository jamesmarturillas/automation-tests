...
/**
 * @case Comment R/W and Flag Job - (Word to Character, Stripe Payment, Standard Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/234
 */
public class C234_2_CommentRWAndFlag extends AutomationBase {
    ...
    public C234_2_CommentRWAndFlag() throws IOException {}
