...
/**
 * @case Comment R/W and Flag Job - (Character to Word, Stripe Payment, Standard Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/234
 */
public class C234_3_CommentRWAndFlag extends AutomationBase {
    ...
    public C234_3_CommentRWAndFlag() throws IOException {}
