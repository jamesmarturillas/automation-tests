...
/**
 * @case Change Layout - (Word to Character, Stripe Payment, Standard Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/235
 */
public class C235_2_ChangeLayout extends AutomationBase{
    ...
    public C235_2_ChangeLayout() throws IOException {}
