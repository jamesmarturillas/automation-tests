...
/**
 * @case Auto-Save - (Word to Character, Paypal Payment, Business Tier)
 * @reference https://gengo.testrail.com/index.php?/cases/view/243
 */
public class C243_AutoSave extends AutomationBase{
    ...
    public C243_AutoSave() throws IOException {}
