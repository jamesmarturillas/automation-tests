 ...
 */
public class C40340_9_HeldJobRejected extends AutomationBase {
    ...
    public C40340_9_HeldJobRejected() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "STANDARD: [Characters - Without HTML tags/Triple brackets]")
