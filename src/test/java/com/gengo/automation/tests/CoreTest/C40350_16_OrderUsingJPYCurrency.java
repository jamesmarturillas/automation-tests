 ...
 * 	Standard, File, Paypal, Word to Word - English to Spanish, 7.00 JPY per word rate
 * @reference https://gengo.testrail.com/index.php?/cases/view/40350
 */
public class C40350_16_OrderUsingJPYCurrency extends AutomationBase {
    ...
    public C40350_16_OrderUsingJPYCurrency() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        customerOrderLanguagesPage.choooseLanguage(var.getSpanishSpainTo());
        ...
        assertEquals(customerOrderQuotePage.getUnitPriceText().getText().replaceAll("[A-z -.]",""), JPY7);
        ...
        assertEquals(customerCheckoutPage.getUnitPriceText().getText().replaceAll("[A-z /]",""), JPY7);

        // Check if the unit prices for Standard and Business tiers are as expected
        assertEquals(customerCheckoutPage.getStandardUnitPriceText().getText().replaceAll("[A-z /]",""), JPY7);
        assertEquals(customerCheckoutPage.getBusinessUnitPriceText().getText().replaceAll("[A-z /]",""), JPY15);
...
//        assertTrue(price.contains(customerOrderDetailsPage.getOrderPrice().getText()));
