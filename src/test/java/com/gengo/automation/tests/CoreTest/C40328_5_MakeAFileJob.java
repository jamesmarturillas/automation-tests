 ...
 * Word to Character, Stripe Payment, Standard Tier, File Job, Without Instruction
 * @reference https://gengo.testrail.com/index.php?/cases/view/40328
 */
public class C40328_5_MakeAFileJob extends AutomationBase {

    private final String SOURCE = "English", TARGET = "Japanese";
    ...
    public void initFields() throws IOException {
        glossaryMatches.put("test", "テスト");
        glossaryMatches.put("record", "記録");
        glossaryMatches.put("gengo", "言語");
        excerpt = var.getExcerptFile(3);
        translatedItem = var.getFile(80);
    ...
    public C40328_5_MakeAFileJob() throws IOException {}
