 ...
 */
public class C40329_4_MakeMultipleTextJobs extends AutomationBase {

    public C40329_4_MakeMultipleTextJobs() throws IOException {}
    ...
    @Test(description = "Stripe payment; Pro; Character", priority = 2)
