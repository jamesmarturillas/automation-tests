...
/**
 * @case Right Panel Information - (Character to Word, Stripe Payment, Business Tier, With Glossary, With Validation)
 * @reference https://gengo.testrail.com/index.php?/cases/view/40345
 */
public class C40345_1_RightPanelInformation extends AutomationBase {
    ...
    public C40345_1_RightPanelInformation() throws IOException {}
    ...
    public void translatorPickUpJob() {
        ...
        workbenchPage.translateTextArea(" ", false);
