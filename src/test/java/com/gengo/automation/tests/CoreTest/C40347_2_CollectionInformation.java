 ...
 */
public class C40347_2_CollectionInformation extends AutomationBase {
    ...
    public C40347_2_CollectionInformation() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "GROUPED [With Tone/Purpose - Standard]")
