...
/**
 * @case Revising Job
 * Word to Word, Credits Payment, Standard Tier, Grouped Job, With Glossary
 * @reference https://gengo.testrail.com/index.php?/cases/view/40338
 */
public class C40338_6_RevisingJob extends AutomationBase {
    ...
    private String[] unitCount,itemToTranslate, excerpts, translatedItem, jobNo = new String[3],
            ...
            glossaryMatches = {"Pagsusulit","Ilagda","Lenggwahe"}, // contains the glossary target texts
            glossaryMatches2 = {"Pagsusulit","Lenggwahe","Ilagda"}, // contains the glossary target texts
            glossaryMatches3 = {"Pagsusulit","Ilagda","Lenggwahe"}, // contains the glossary target texts
    ...
    public void initFields() throws IOException{
        ...
        itemToTranslate = new String[] {
                ...
                var.getItemToTranslate(44),
                var.getItemToTranslate(45)
        };
        unitCount = new String[] {
                var.getUnitCountSource(23),
                var.getUnitCountSource(44),
                var.getUnitCountSource(45)
        };
        translatedItem = new String[] {
                var.getTranslatedItem(23),
                var.getTranslatedItem(44),
                var.getTranslatedItem(45)
        };
    }

    public C40338_6_RevisingJob() throws IOException {}
    ...
    public void customerRequestCorrection() {
        ...
        // Loops through the jobs and requests for correction for them all
    ...
    public void translatorRevise() throws AWTException {
        pluginPage.passThisPage();
        assertTrue(homePage.getSignIn().isDisplayed(),
                var.getElementNotFoundErrMsg());
