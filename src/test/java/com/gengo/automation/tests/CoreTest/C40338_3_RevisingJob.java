...
/**
 * @case Revising Job
 * Word to Character, Credits Payment, Standard Tier, Text Job, With Glossary
 * @reference https://gengo.testrail.com/index.php?/cases/view/40338
 */
public class C40338_3_RevisingJob extends AutomationBase {
    ...
    public void initFields() throws IOException{
        ...
        revisedTranslation = var.getTranslatedItem(21);
    }

    public C40338_3_RevisingJob() throws IOException {}
