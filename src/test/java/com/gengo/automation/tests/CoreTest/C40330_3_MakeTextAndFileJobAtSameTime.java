 ...
 */
public class C40330_3_MakeTextAndFileJobAtSameTime extends AutomationBase {

    public C40330_3_MakeTextAndFileJobAtSameTime() throws IOException {}
    ...
    @Test(description = "Stripe payment; Pro", priority = 2)
