 ...
 */
public class C40352_5_OrderUsingEURCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40352_5_OrderUsingEURCurrency() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "WITHOUT CREDITS - Retail - SINGLE JOB (STANDARD) - Stripe")
    public void placeAnOrder() {
        ...
        customerOrderLanguagesPage.choooseLanguage(var.getThaiTo());
        ...
        assertTrue(customerOrderCompletePage.isDeductedRight
                (unitCounts[0], Constants.EUR_STD_EN_TH_POINT06), var.getTextNotEqualErrMsg());
