 ...
 * 	Pro, Single, Credits, Word to Word - English to Danish, 0.14 GBP per word rate
 * @reference https://gengo.testrail.com/index.php?/cases/view/40351
 */
public class C40351_11_OrderUsingGBPCurrency extends AutomationBase {
    ...
    public C40351_11_OrderUsingGBPCurrency() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        assertEquals(price, customerCheckoutPage.getFullQuoteTotalPrice(), var.getTextNotEqualErrMsg());
        ...
        assertEquals(customerOrderQuotePage.getUnitPriceText().getText().replaceAll("[A-z -]",""), GBP014);
        ...
        assertEquals(customerCheckoutPage.getUnitPriceText().getText().replaceAll("[A-z /]",""), GBP014);
