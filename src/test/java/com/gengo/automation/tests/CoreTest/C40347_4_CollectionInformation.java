 ...
 */
public class C40347_4_CollectionInformation extends AutomationBase {
    ...
    public C40347_4_CollectionInformation() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "GROUPED [Without Tone/Purpose - Standard]")
