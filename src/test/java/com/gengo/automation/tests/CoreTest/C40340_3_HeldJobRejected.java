 ...
 */
public class C40340_3_HeldJobRejected extends AutomationBase {
    ...
    public C40340_3_HeldJobRejected() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "STANDARD: [File job - Word - Without HTML tags/Triple brackets]")
