 ...
 */
public class C40331_12_MakeJobForPreferredTranslator extends AutomationBase {

    public C40331_12_MakeJobForPreferredTranslator() throws IOException {}
    ...
    @Test(description = "Single/Pro/File/Character without HTML tags or Triple brackets", priority = 3)
