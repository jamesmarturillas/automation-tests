...
/**
 * @case Revising Job
 * Character to Character, Paypal Payment, Pro Tier, Text Job, Without Glossary
 * @reference https://gengo.testrail.com/index.php?/cases/view/40338
 */
public class C40338_4_RevisingJob extends AutomationBase {

    private String parentWindow, orderNo, excerpt, translatedItem, revisedItem, jobNo, price, instruction;
    ...
    public void initFields() throws IOException {
        ...
        translatedItem = var.getTranslatedItem(22).substring(10);
        revisedItem = var.getTranslatedItem(22);
    }

    public C40338_4_RevisingJob() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        assertFalse(customerOrderDetailsPage.checkInstruction(instruction), var.getElementIsDisplayedErrMsg());
    ...
    public void translatorRevise() {
        ...
        // Text to be translated is added
        workbenchPage.translateAndSubmitJob(revisedItem);
