...
/**
 * @case Revising Job
 * Character to Word, Stripe Payment, Pro Tier, With Instructions, Grouped Job, Without Glossary
 * @reference https://gengo.testrail.com/index.php?/cases/view/40338
 */
public class C40338_5_RevisingJob extends AutomationBase{

    private String parentWindow, orderNo, excerpt, instruction ;
    private String[] itemToTranslate, revisedItem, unitCount, translatedItem, excerpts, jobNo = new String[3];
    ...
    public void initFields() throws IOException{
        ...
        itemToTranslate = new String[] {
                var.getItemToTranslate(28),
                var.getItemToTranslate(29),
                var.getItemToTranslate(30)
        };
        unitCount = new String[] {
                var.getUnitCountSource(28),
                var.getUnitCountSource(29),
                var.getUnitCountSource(30)
        };
        ...
        revisedItem = new String[] {
                var.getTranslatedItem(28),
                var.getTranslatedItem(29),
                var.getTranslatedItem(30)
        };
    }

    public C40338_5_RevisingJob() throws IOException {}
    ...
    public void customerRequestCorrection() {
        ...
        // Loops through the jobs and requests revision for them all
    ...
    public void translatorRevise() {
        ...
        // Add translated items and submit
        workbenchPage.addMultipleTranslatedText(revisedItem, excerpts,3);
