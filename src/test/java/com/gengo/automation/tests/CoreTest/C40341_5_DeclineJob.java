 ...
 */
public class C40341_5_DeclineJob extends AutomationBase {
    ...
    public C40341_5_DeclineJob() throws IOException {}
    ...
    @Test(description = "Submitted job won't be cancelled", dependsOnMethods = "createCustomerAccount")
    ...
    public void pickUpByTranslator() throws IOException {
        ...
        // Assert that there are no way that the submitted job can be cancelled anymore.
        assertFalse(elementState.isElementPresent
                (workbenchFilePage.getFileJobDeclineReasons()), var.getElementIsDisplayedErrMsg());
