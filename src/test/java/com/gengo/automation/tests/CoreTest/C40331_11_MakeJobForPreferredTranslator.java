 ...
 */
public class C40331_11_MakeJobForPreferredTranslator extends AutomationBase {

    public C40331_11_MakeJobForPreferredTranslator() throws IOException {}
    ...
    public void initFields() throws IOException{
        ...
        fileNames.add(var.getFileName(58));
    ...
    @Test(description = "Single/Standard/File/Character without HTML tags or Triple brackets", priority = 3)
