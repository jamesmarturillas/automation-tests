...
/**
 * @case Revising Job
 * Word to Word, Stripe Payment, Pro Tier, Text Job, Without Glossary
 * @reference https://gengo.testrail.com/index.php?/cases/view/40338
 */
public class C40338_2_RevisingJob extends AutomationBase {
    ...
    public void initFields() throws IOException{
        ...
        translatedItem = var.getTranslatedItem(23).substring(68 );

        revisedItem = var.getTranslatedItem(23);
    }

    public C40338_2_RevisingJob() throws IOException {}
