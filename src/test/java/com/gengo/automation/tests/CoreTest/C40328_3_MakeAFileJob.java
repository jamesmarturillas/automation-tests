 ...
 * Word to Word, Stripe Payment, Standard Tier, File Job, With Instruction
 * @reference https://gengo.testrail.com/index.php?/cases/view/40328
 */
public class C40328_3_MakeAFileJob extends AutomationBase {

    private final String SOURCE = "Japanese", TARGET = "Tagalog";
    ...
    public C40328_3_MakeAFileJob() throws IOException {}
