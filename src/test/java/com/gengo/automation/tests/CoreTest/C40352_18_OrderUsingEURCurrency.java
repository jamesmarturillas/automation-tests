 ...
 */
public class C40352_18_OrderUsingEURCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40352_18_OrderUsingEURCurrency() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        assertTrue(customerOrderCompletePage.isDeductedRight
                (unitCounts[0], Constants.EUR_PRO_EN_TL_POINT12), var.getTextNotEqualErrMsg());
