 ...
 */
public class C40331_6_MakeJobForPreferredTranslator extends AutomationBase {

    public C40331_6_MakeJobForPreferredTranslator() throws IOException {}
    ...
    public void initFields() throws IOException{
        ...
        excerpts.add(var.getExcerptNonEnglish(20));
        excerpts.add(var.getExcerptNonEnglish(21));
        ...
        unitCounts = new String[] {
                var.getUnitCountTarget(25),
                var.getUnitCountTarget(26),
                var.getUnitCountTarget(27),
        };
    ...
    @Test(description = "Group/Standard/Text/Character without HTML tags or Triple brackets", priority = 3)
