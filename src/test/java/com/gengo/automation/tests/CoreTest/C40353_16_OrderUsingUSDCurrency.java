 ...
 */
public class C40353_16_OrderUsingUSDCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40353_16_OrderUsingUSDCurrency() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "WITHOUT CREDITS - Retail - GROUPED JOBS (PRO) - Stripe")
    public void placeAnOrder() {
        ...
        // Assert that the price deducted is correct.
        assertTrue(customerOrderCompletePage.isDeductedRight(customerOrderCompletePage.extractedUnitCount(), Constants.USD_PRO_EN_JA_POINT14), var.getTextNotEqualErrMsg());
