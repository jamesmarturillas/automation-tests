 ...
 */
public class C40352_2_OrderUsingEURCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40352_2_OrderUsingEURCurrency() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "WITHOUT CREDITS - Retail - SINGLE JOB (PRO) - PayPal")
    public void placeAnOrder() {
        ...
        assertTrue(customerOrderCompletePage.isDeductedRight
                (unitCounts[0], Constants.EUR_PRO_EN_ES_POINT12), var.getTextNotEqualErrMsg());
