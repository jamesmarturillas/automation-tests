 ...
 */
public class C40342_1_IncompleteJob extends AutomationBase {

    public C40342_1_IncompleteJob() throws IOException {}
    ...
    public void pickUpByTranslator() throws IOException {
        ...
        workbenchPage.translateJob(translatedItems[translatedItems.length - 1]);
        assertTrue(page.getCurrentUrl().equals(translatorDashboardPage.TRANSLATOR_DASHBOARD_URL),
                var.getWrongUrlErrMsg());
    }
