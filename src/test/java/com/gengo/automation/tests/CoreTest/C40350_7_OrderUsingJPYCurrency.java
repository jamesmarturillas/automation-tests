 ...
 * 	Pro, Group, Paypal, Word to Word - English to Spanish, 15.00 JPY per word rate
 * @reference https://gengo.testrail.com/index.php?/cases/view/40350
 */
public class C40350_7_OrderUsingJPYCurrency extends AutomationBase{
    ...
    public C40350_7_OrderUsingJPYCurrency() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        assertEquals(customerOrderQuotePage.getUnitPriceText().getText().replaceAll("[A-z -.]",""), JPY15);
        ...
        assertEquals(customerCheckoutPage.getUnitPriceText().getText().replaceAll("[A-z /]",""), JPY15);
