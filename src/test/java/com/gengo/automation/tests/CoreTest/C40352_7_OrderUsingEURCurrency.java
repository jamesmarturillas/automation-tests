 ...
 */
public class C40352_7_OrderUsingEURCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40352_7_OrderUsingEURCurrency() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        assertTrue(customerOrderCompletePage.isDeductedRight
                (customerOrderCompletePage.extractedUnitCount(), Constants.EUR_STD_EN_ZH_POINT08), var.getTextNotEqualErrMsg());
