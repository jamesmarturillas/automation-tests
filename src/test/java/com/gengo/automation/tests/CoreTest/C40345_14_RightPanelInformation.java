...
/**
 * @case Right Panel Information - (Word to Word, Credits Payment, Business Tier, With Glossary, With Validation, Ungrouped)
 * @reference https://gengo.testrail.com/index.php?/cases/view/40345
 */
public class C40345_14_RightPanelInformation extends AutomationBase {
    ...
    public C40345_14_RightPanelInformation() throws IOException {}
