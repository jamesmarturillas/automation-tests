 ...
 */
public class C40353_19_OrderUsingUSDCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40353_19_OrderUsingUSDCurrency() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        assertTrue(customerOrderCompletePage.isDeductedRight
                (customerOrderCompletePage.extractedUnitCount(), Constants.USD_STD_EN_ENGB_POINT04), var.getTextNotEqualErrMsg());
