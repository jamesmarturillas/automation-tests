 ...
 * Character to Word, Stripe Payment, Standard Tier, Text Job, Large Character Count
 * @reference https://gengo.testrail.com/index.php?/cases/view/40333
 */
public class C40333_11_MakeJobWithGlossaryFile extends AutomationBase {
    ...
    public void initFields() throws IOException{
        ...
        translatedItem = var.getTranslatedItem(51);
    }

    public C40333_11_MakeJobWithGlossaryFile() throws IOException {}
