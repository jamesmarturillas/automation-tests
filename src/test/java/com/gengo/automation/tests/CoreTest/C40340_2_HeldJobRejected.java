 ...
 */
public class C40340_2_HeldJobRejected extends AutomationBase {
    ...
    public C40340_2_HeldJobRejected() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "STANDARD: [Group job - Word - Without HTML tags/Triple brackets]")
    ...
    public void customerRejectsTheJob() {
        ...
        // Find the job and cancel all jobs.
        customerOrdersPage.rejectOrders(excerpts, jobIds);
