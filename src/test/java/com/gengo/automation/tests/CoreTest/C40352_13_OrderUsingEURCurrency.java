 ...
 */
public class C40352_13_OrderUsingEURCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40352_13_OrderUsingEURCurrency() throws IOException {}

    @BeforeClass
    public void initFields() throws IOException{
        this.newUser = csv.generateNewUser(var.SHEETNAME_CUSTOMERS, 0);
        itemToTranslates = new String[] {
                var.getItemToTranslate(68),
                var.getItemToTranslate(69),
                var.getItemToTranslate(70),
        };
        unitCounts = new String[] {
                var.getUnitCountSource(68),
                var.getUnitCountSource(69),
                var.getUnitCountSource(70),
        };
    }
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "WITHOUT CREDITS - Retail - GROUPED CHAR JOBS (STANDARD) - PayPal")
    public void placeAnOrder() {
        ...
        assertTrue(customerOrderLanguagesPage.isSourceAutoDetected(var.getChineseSimplifiedFrom()),
        ...
        assertTrue(customerOrderCompletePage.isDeductedRight
                (customerOrderCompletePage.extractedUnitCount(), Constants.EUR_STD_ZH_EN_POINT04), var.getTextNotEqualErrMsg());
