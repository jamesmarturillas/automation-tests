 ...
 */
public class C40331_5_MakeJobForPreferredTranslator extends AutomationBase {

    public C40331_5_MakeJobForPreferredTranslator() throws IOException {}
    ...
    public void initFields() throws IOException{
        ...
        excerpt = var.getExcerptNonEnglish(10);
    ...
    @Test(description = "Single/Standard/Text/Character without HTML tags or Triple brackets", priority = 3)
