 ...
 */
public class C40353_23_OrderUsingUSDCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40353_23_OrderUsingUSDCurrency() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "WITHOUT CREDITS - Retail - GROUPED JOBS (STANDARD) - Stripe")
