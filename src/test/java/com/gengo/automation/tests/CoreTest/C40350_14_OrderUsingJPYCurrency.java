 ...
 * 	Standard, Single, Credits, Character to Character - Japanese to Chinese (Traditional), 5.00 JPY per word rate
 * @reference https://gengo.testrail.com/index.php?/cases/view/40350
 */
public class C40350_14_OrderUsingJPYCurrency extends AutomationBase {
    ...
    public void initFields() throws IOException{
        ...
        translatedItem = var.getTranslatedItem(60);
    }

    public C40350_14_OrderUsingJPYCurrency() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        assertEquals(customerOrderQuotePage.getUnitPriceText().getText().replaceAll("[A-z -.]",""), JPY5);
        ...
        assertEquals(customerCheckoutPage.getUnitPriceText().getText().replaceAll("[A-z /]",""), JPY5);
