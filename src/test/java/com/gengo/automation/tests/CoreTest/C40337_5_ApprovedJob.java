 ...
 */
public class C40337_5_ApprovedJob extends AutomationBase {

    public C40337_5_ApprovedJob() throws IOException {}
    ...
    @Test(description = "Text/Standard/Single/Character with HTML tags or Triple brackets", priority = 2)
