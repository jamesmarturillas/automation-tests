 ...
 */
public class C40353_26_OrderUsingUSDCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40353_26_OrderUsingUSDCurrency() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        assertTrue(customerOrderCompletePage.isDeductedRight
                (unitCounts[0], Constants.USD_PRO_EN_TL_POINT12), var.getTextNotEqualErrMsg());
