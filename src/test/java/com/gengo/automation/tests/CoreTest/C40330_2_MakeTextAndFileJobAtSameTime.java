 ...
 */
public class C40330_2_MakeTextAndFileJobAtSameTime extends AutomationBase {

    public C40330_2_MakeTextAndFileJobAtSameTime() throws IOException {}
    ...
    @Test(description = "Stripe payment; Standard", priority = 2)
