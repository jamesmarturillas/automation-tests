...
/**
 * @case Create new translator account - EMAIL
 * @reference https://gengo.testrail.com/index.php?/cases/view/40335
 */
public class C40335_1_CreateTranslatorAccount extends AutomationBase {

    private Select selectCountry;

    public C40335_1_CreateTranslatorAccount() throws IOException {}

    @BeforeClass
    public void initField() {
        this.newUser = signUpPage.newTranslator();
    }
