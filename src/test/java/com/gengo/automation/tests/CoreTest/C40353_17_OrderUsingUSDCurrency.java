 ...
 */
public class C40353_17_OrderUsingUSDCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40353_17_OrderUsingUSDCurrency() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        assertTrue(customerOrderCompletePage.isDeductedRight
                (unitCounts[0], Constants.USD_STD_EN_ENGB_POINT04), var.getTextNotEqualErrMsg());
