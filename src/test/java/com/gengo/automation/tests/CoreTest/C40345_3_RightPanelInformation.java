...
/**
 * @case Right Panel Information
 * Word to Character, Credits Payment, Standard Tier, Text Job, With Glossary, With Validation
 * @reference https://gengo.testrail.com/index.php?/cases/view/40345
 */
public class C40345_3_RightPanelInformation extends AutomationBase {
    ...
    public void initFields() throws IOException{
        ...
        translatedItem = var.getTranslatedItem(21);
    }

    public C40345_3_RightPanelInformation() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        System.out.println("Test " + page.getCurrentUrl());
        System.out.println("Test2 " + customerDashboardPage.CUSTOMER_DASHBOARD_URL);
