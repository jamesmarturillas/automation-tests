 ...
 */
public class C40340_10_HeldJobRejected extends AutomationBase {
    ...
    public C40340_10_HeldJobRejected() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "PRO: [Characters - With HTML tags/Triple brackets]")
