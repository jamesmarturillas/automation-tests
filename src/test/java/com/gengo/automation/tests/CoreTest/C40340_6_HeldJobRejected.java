 ...
 */
public class C40340_6_HeldJobRejected extends AutomationBase {
    ...
    public C40340_6_HeldJobRejected() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "PRO: [Word - With HTML tags/Triple brackets]")
