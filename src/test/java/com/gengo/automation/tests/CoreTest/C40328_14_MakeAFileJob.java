 ...
 * Character to Word, Stripe Payment, Standard Tier, File Job, With Instruction, < 100 MB File
 * @reference https://gengo.testrail.com/index.php?/cases/view/40328
 */
public class C40328_14_MakeAFileJob extends AutomationBase {
    ...
    public void initFields() throws IOException{
        ...
        excerpt = var.getExcerptFile(9);
        translatedItem = var.getFile(57);
    ...
    public C40328_14_MakeAFileJob() throws IOException {}
