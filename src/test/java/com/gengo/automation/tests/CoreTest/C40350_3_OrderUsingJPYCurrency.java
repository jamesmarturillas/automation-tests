 ...
 * 	Pro, Single, Paypal, Word to Character - English to Japanese, 17.00 JPY per word rate
 * @reference https://gengo.testrail.com/index.php?/cases/view/40350
 */
public class C40350_3_OrderUsingJPYCurrency extends AutomationBase {
    ...
    public void initFields() throws IOException{
        ...
        itemToTranslate = new String[] {
                var.getItemToTranslate(58)
        };
        unitCount = new String[] {
                var.getUnitCountSource(58)
        };
        translatedItem = var.getTranslatedItem(58);
    }

    public C40350_3_OrderUsingJPYCurrency() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        assertEquals(customerOrderQuotePage.getUnitPriceText().getText().replaceAll("[A-z -.]",""), JPY17);
        ...
        assertEquals(customerCheckoutPage.getUnitPriceText().getText().replaceAll("[A-z /]",""), JPY17);
