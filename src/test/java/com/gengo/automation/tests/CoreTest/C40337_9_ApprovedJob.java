 ...
 */
public class C40337_9_ApprovedJob extends AutomationBase {

    public C40337_9_ApprovedJob() throws IOException {}
    ...
    @Test(description = "File/Standard/Single/Character with HTML tags or Triple brackets", priority = 2)
