 ...
 * 	Pro, Group, Paypal, Word to Word - Japanese to English, 0.070 GBP per word rate
 * @reference https://gengo.testrail.com/index.php?/cases/view/40351
 */
public class C40351_8_OrderUsingGBPCurrency extends AutomationBase{
    ...
    public void initFields() throws IOException{
        ...
        itemToTranslate = new String[] {
                ...
                var.getItemToTranslate(63)
        };
        unitCount = new String[] {
                var.getUnitCountSource(62),
                var.getUnitCountSource(63)
        };
        translatedItem = new String[] {
                var.getTranslatedItem(62),
                var.getTranslatedItem(63)
        };
    }

    public C40351_8_OrderUsingGBPCurrency() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        assertEquals(customerOrderQuotePage.getUnitPriceText().getText().replaceAll("[A-z -]",""), GBP07);
        ...
        assertEquals(customerCheckoutPage.getUnitPriceText().getText().replaceAll("[A-z /]",""), GBP07);
