 ...
 */
public class C40340_1_HeldJobRejected extends AutomationBase {
    ...
    public C40340_1_HeldJobRejected() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "STANDARD: [Single job - Word - Without HTML tags/Triple brackets]")
