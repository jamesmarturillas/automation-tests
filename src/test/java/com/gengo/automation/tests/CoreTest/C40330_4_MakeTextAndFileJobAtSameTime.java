 ...
 */
public class C40330_4_MakeTextAndFileJobAtSameTime extends AutomationBase {

    public C40330_4_MakeTextAndFileJobAtSameTime() throws IOException {}
    ...
    @Test(description = "Stripe payment; Standard; Character", priority = 2)
