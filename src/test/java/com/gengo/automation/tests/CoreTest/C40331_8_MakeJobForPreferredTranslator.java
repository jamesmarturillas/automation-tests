 ...
 */
public class C40331_8_MakeJobForPreferredTranslator extends AutomationBase {

    public C40331_8_MakeJobForPreferredTranslator() throws IOException {}
    ...
    @Test(description = "Group/Pro/Text/Character without HTML tags or Triple brackets", priority = 3)
