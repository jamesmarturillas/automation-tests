 ...
 */
public class C40331_1_MakeJobForPreferredTranslator extends AutomationBase {

    public C40331_1_MakeJobForPreferredTranslator() throws IOException {}
    ...
    @Test(description = "Single/Standard/Text/Word without HTML tags or Triple brackets", priority = 3)
    public void placeAnOrder() throws IOException {
        ...
        // Choose the preferred translator
