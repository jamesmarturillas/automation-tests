...
/**
 * @case Make A File Job
 * Character to Character, Paypal Payment, Standard Tier, File Job, Without Instruction
 * @reference https://gengo.testrail.com/index.php?/cases/view/40328
 */
public class C40328_7_MakeAFileJob extends AutomationBase {

    private final String SOURCE = "Japanese", TARGET = "Chinese (Simplified)";
    ...
    public void initFields() throws IOException{
        glossaryMatches.put("言語", "语言");
        glossaryMatches.put("テスト", "测试");
        glossaryMatches.put("記録", "记录");
        excerpt = var.getExcerptFile(4);
        translatedItem = var.getFile(83);
    ...
    public C40328_7_MakeAFileJob() throws IOException {}
