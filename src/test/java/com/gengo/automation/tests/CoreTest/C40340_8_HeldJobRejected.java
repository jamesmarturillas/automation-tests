 ...
 */
public class C40340_8_HeldJobRejected extends AutomationBase {
    ...
    public C40340_8_HeldJobRejected() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "STANDARD: [Characters - With HTML tags/Triple brackets]")
