 ...
 */
public class C40352_9_OrderUsingEURCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40352_9_OrderUsingEURCurrency() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "WITHOUT CREDITS - Retail - SINGLE CHAR JOB (STANDARD) - PayPal")
    public void placeAnOrder() {
        ...
        assertTrue(customerOrderCompletePage.isDeductedRight
                (unitCounts[0], Constants.EUR_STD_JA_EN_POINT04), var.getTextNotEqualErrMsg());
