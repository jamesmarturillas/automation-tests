 ...
 * 	Pro, Group, Paypal, Word to Word - English to Spanish, 0.110 GBP per word rate
 * @reference https://gengo.testrail.com/index.php?/cases/view/40351
 */
public class C40351_7_OrderUsingGBPCurrency extends AutomationBase{
    ...
    public C40351_7_OrderUsingGBPCurrency() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        assertEquals(customerOrderQuotePage.getUnitPriceText().getText().replaceAll("[A-z -]",""), GBP011);
        ...
        assertEquals(customerCheckoutPage.getUnitPriceText().getText().replaceAll("[A-z /]",""), GBP011);
