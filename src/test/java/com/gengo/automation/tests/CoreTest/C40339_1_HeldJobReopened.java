 ...
 */
public class C40339_1_HeldJobReopened extends AutomationBase {

    private String parentWindow, orderNo;
    private String[] itemToTranslate, jobNo = new String[5];
    ...
    public C40339_1_HeldJobReopened() throws IOException {}
    ...
    /**
     * customerReject --- this method rejects the job
     * */
    ...
    public void customerReject(){
        ...
        for(String text: excerpts) {
            ...
            // Job is rejected
            customerOrderDetailsPage.rejectTranslation("Improper translation", false, Constants.REJECTION_REASON_QUALITY);
        }
