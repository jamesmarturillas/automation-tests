 ...
 */
public class C40346_2_LeftPanelInformation extends AutomationBase {

    public C40346_2_LeftPanelInformation() throws IOException {}
    ...
    @Test(description = "Grouped job.", priority = 2)
