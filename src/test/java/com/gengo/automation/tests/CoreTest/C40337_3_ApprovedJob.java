 ...
 */
public class C40337_3_ApprovedJob extends AutomationBase {

    public C40337_3_ApprovedJob() throws IOException {}
    ...
    @Test(description = "Text/Pro/Single/Word with HTML tags or Triple brackets", priority = 2)
    public void placeAnOrder() throws IOException {
        ...
        // Select 'Business' tier for PRO order.
