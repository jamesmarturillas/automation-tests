 ...
 */
public class C40352_8_OrderUsingEURCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40352_8_OrderUsingEURCurrency() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        assertTrue(customerOrderCompletePage.isDeductedRight
                (customerOrderCompletePage.extractedUnitCount(), Constants.EUR_PRO_EN_ZH_POINT14), var.getTextNotEqualErrMsg());
