...
/**
 * @case Right Panel Information - (Character to Character, Credits Payment, Business Tier, With Glossary, With Validation, Ungrouped)
 * @reference https://gengo.testrail.com/index.php?/cases/view/40345
 */
public class C40345_15_RightPanelInformation extends AutomationBase {
    ...
    public C40345_15_RightPanelInformation() throws IOException {}
