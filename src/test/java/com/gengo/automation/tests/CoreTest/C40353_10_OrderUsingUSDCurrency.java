 ...
 */
public class C40353_10_OrderUsingUSDCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40353_10_OrderUsingUSDCurrency() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        assertTrue(customerOrderCompletePage.isDeductedRight
                (unitCounts[0], Constants.USD_PRO_EN_JA_POINT14), var.getTextNotEqualErrMsg());
