 ...
 */
public class C40331_7_MakeJobForPreferredTranslator extends AutomationBase {

    public C40331_7_MakeJobForPreferredTranslator() throws IOException {}
    ...
    @Test(description = "Single/Pro/Text/Character without HTML tags or Triple brackets", priority = 3)
