 ...
 */
public class C40352_16_OrderUsingEURCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40352_16_OrderUsingEURCurrency() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "WITHOUT CREDITS - Retail - GROUPED CHAR JOBS (PRO) - Stripe")
    public void placeAnOrder() {
        ...
        assertTrue(customerOrderCompletePage.isDeductedRight
                (customerOrderCompletePage.extractedUnitCount(), Constants.EUR_PRO_JA_EN_POINT08), var.getTextNotEqualErrMsg());
