 ...
 */
public class C40347_3_CollectionInformation extends AutomationBase {
    ...
    public C40347_3_CollectionInformation() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "SINGLE [Without Tone/Purpose - Standard]")
