 ...
 */
public class C40331_4_MakeJobForPreferredTranslator extends AutomationBase {

    public C40331_4_MakeJobForPreferredTranslator() throws IOException {}
    ...
    @Test(description = "Group/Pro/Text/Word without HTML tags or Triple brackets", priority = 3)
