 ...
 */
public class C40347_6_CollectionInformation extends AutomationBase {
    ...
    public C40347_6_CollectionInformation() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "GROUPED [With Tone/Purpose - Pro]")
