 ...
 */
public class C40337_7_ApprovedJob extends AutomationBase {

    public C40337_7_ApprovedJob() throws IOException {}
    ...
    public void initFields() throws IOException{
        ...
        excerpt = var.getExcerptFile(6);
        excerpts.add(excerpt);

        fileName.add(var.getFileName(13));
    ...
    @Test(description = "File/Standard/Single/Word with HTML tags or Triple brackets", priority = 2)
