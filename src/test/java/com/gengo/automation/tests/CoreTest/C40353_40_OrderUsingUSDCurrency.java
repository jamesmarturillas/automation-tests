 ...
 */
public class C40353_40_OrderUsingUSDCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40353_40_OrderUsingUSDCurrency() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "WITH CREDITS - Retail - GROUPED JOBS (PRO)")
    public void placeAnOrder() {
        ...
        assertTrue(customerOrderCompletePage.isDeductedRight
                (customerOrderCompletePage.extractedUnitCount(), Constants.USD_PRO_EN_JA_POINT14), var.getTextNotEqualErrMsg());
