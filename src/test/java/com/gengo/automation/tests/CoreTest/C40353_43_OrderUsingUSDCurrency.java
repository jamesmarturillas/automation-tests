 ...
 */
public class C40353_43_OrderUsingUSDCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40353_43_OrderUsingUSDCurrency() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "WITH CREDITS - Retail - GROUPED JOBS (STANDARD)")
