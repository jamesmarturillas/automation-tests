 ...
 */
public class C40353_42_OrderUsingUSDCurrency extends AutomationBase {

    private String[] itemToTranslates;
    private String[] unitCounts;

    public C40353_42_OrderUsingUSDCurrency() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "WITH CREDITS - Retail - SINGLE JOB (PRO)")
