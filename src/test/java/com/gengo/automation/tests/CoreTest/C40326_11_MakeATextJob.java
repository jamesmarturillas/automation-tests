 ...
 * Character to Character, With Credits, Standard Tier, With Instruction
 * @reference https://gengo.testrail.com/index.php?/cases/view/40326
 */
public class C40326_11_MakeATextJob extends AutomationBase {

    private String parentWindow, orderNo, excerpt, translatedItem, jobNo, price, instruction;
    ...
    public void initFields() throws IOException{
        ...
        translatedItem = var.getTranslatedItem(22);
    }

    public C40326_11_MakeATextJob() throws IOException {}
