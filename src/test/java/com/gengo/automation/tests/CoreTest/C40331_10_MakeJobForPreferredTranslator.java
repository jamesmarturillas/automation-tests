 ...
 */
public class C40331_10_MakeJobForPreferredTranslator extends AutomationBase {

    public C40331_10_MakeJobForPreferredTranslator() throws IOException {}
    ...
    @Test(description = "Single/Pro/File/Word without HTML tags or Triple brackets", priority = 3)
