 ...
 */
public class C40340_4_HeldJobRejected extends AutomationBase {
    ...
    public C40340_4_HeldJobRejected() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "STANDARD: [Word - With HTML tags/Triple brackets]")
