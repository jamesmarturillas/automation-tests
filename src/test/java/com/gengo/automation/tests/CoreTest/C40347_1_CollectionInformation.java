 ...
 */
public class C40347_1_CollectionInformation extends AutomationBase {
    ...
    public C40347_1_CollectionInformation() throws IOException {}
    ...
    @Test(dependsOnMethods = "createCustomerAccount", description = "SINGLE [With Tone/Purpose - Standard]")
