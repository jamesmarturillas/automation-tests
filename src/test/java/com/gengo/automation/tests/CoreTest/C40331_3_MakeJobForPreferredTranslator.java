 ...
 */
public class C40331_3_MakeJobForPreferredTranslator extends AutomationBase {

    public C40331_3_MakeJobForPreferredTranslator() throws IOException {}
    ...
    @Test(description = "Single/Pro/Text/Word without HTML tags or Triple brackets", priority = 3)
    ...
    public void pickUpByNonPreferredTranslator() throws IOException {
        ...
        loginPage.loginAccount(var.getTranslatorPro(3), var.getDefaultPassword(), true);
