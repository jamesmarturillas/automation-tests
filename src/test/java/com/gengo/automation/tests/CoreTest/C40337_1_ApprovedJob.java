 ...
 */
public class C40337_1_ApprovedJob extends AutomationBase {

    public C40337_1_ApprovedJob() throws IOException {}
    ...
    @Test(description = "Text/Standard/Single/Word with HTML tags or Triple brackets", priority = 2)
