...
/**
 * @case Revising Job
 * Character to Word, Paypal Payment, Standard Tier, Text Job, With Glossary
 * @reference https://gengo.testrail.com/index.php?/cases/view/40338
 */
public class C40338_1_RevisingJob extends AutomationBase {

    private String parentWindow, orderNo, excerpt, jobNo, price, revisedTranslation;
    private String[] unitCount,itemToTranslate,
            glossaryTexts = {"テスト","記録","言語"}, // contains the glossary source texts
            glossaryMatches = {"Test","Record","Gengo"}, // contains the glossary target texts
            highlightGlossary = {"テスト","記録","言語","テスト"}, // contains the words in the source text that has glossary matches
            highlightWarning = {"1", "2"}, // texts that trigger warning validation
    ...
    public void initFields() throws IOException{
        ...
        revisedTranslation = var.getTranslatedItem(22);
    }

    public C40338_1_RevisingJob() throws IOException {}
    ...
    public void placeAnOrder() {
        ...
        assertEquals(price.replaceAll("[$€£¥]", ""), customerOrderCompletePage.totalPrice().toPlainString(), var.getTextNotEqualErrMsg());
    ...
    public void customerRequestCorrection() {
        ...
        // Request correction for the translation
    ...
    public void translatorRevise() throws AWTException {
        ...
        workbenchPage.translateAndSubmitJob(revisedTranslation);
