...
/**
 * @case Create new account with Google account -> Translator
 * @reference https://gengo.testrail.com/index.php?/cases/view/4
 */
public class C4_2_CreateNewAccountWithGoogleAccount extends AutomationBase {

    private String parentWindow;
    private Select selectCountry;

    public C4_2_CreateNewAccountWithGoogleAccount() throws IOException {}
     ...
     *  the admin page to edit the 'gengo.automationtest@gmail.com' email
     *  from 'OtherAccounts' sheet of DataSource.xls file.
     *  The purpose is to be able to create another 'gengo.automationtest@gmail.com'
     *  using Google account to avoid multiple creation of Google accounts
