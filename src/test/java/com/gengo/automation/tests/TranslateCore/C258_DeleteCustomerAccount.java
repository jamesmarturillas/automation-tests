...
/**
 * @case Deleting a customer account.
 * @reference https://gengo.testrail.com/index.php?/cases/view/258
 */
public class C258_DeleteCustomerAccount extends AutomationBase {

    public C258_DeleteCustomerAccount() throws IOException {}
    ...
    public void checkAccountIfStillCanLogin() {
        ...
        // Login as closed customer account.
        loginPage.loginAccount(this.newUser, var.getDefaultPassword());

        // Assert that the account cannot pay anymore.
