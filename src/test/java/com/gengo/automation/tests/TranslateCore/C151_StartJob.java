...
/**
 * @case Start job
 * @reference https://gengo.testrail.com/index.php?/cases/view/151
 */
public class C151_StartJob extends AutomationBase {

    public C151_StartJob() throws IOException {
    }
    ...
    public void pickUpByTranslator() {
        ...
        // Close workbench modal, start and submit translation
