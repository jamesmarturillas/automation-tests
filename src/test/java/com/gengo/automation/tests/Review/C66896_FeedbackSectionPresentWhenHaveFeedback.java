...
/**
 * @case Translators should be able to see the "Feedback to the translator:" portion of review
 * @reference https://www.pivotaltracker.com/story/show/146507023
 */
public class C66896_FeedbackSectionPresentWhenHaveFeedback extends AutomationBase {

    public C66896_FeedbackSectionPresentWhenHaveFeedback() throws IOException {}
    ...
    public void gocheckWithFeedback() {
        pluginPage.passThisPage();
        assertTrue(homePage.getSignIn().isDisplayed(),
                var.getElementNotFoundErrMsg());
        ...
        // Submit 10.0 score check with Feedback
    ...
    @Test(dependsOnMethods = "gocheckWithFeedback")
    public void goToReview() {
        ...
        // Check existence of feedback area if existing
        wait.impWait(30, reviewPage.getTargetContent());
        assertTrue(reviewPage.getFeedbackArea().isDisplayed());
        // Commented out for now for future implementation
//        assertEquals(var.getCheckerFeedback(), reviewPage.getFeedbackContent().getText());
    }
