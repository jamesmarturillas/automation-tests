...
/**
 * @case Translators should not be able to see the "Feedback to the translator:" portion of review when added space only
 * @reference https://www.pivotaltracker.com/story/show/146507023
 */
public class C66896_FeedbackSectionRemovedWhenSpaceFeedback extends AutomationBase {

    public C66896_FeedbackSectionRemovedWhenSpaceFeedback() throws IOException {}
    ...
    public void gocheckWithSpaceFeedback() {
        pluginPage.passThisPage();
        assertTrue(homePage.getSignIn().isDisplayed(),
                var.getElementNotFoundErrMsg());
        ...
        // Add feedback containing spaces only
        goCheckPage.writeFeedbackToTranslator(" ");

        // Submit 10.0 score check with space Feedback
    ...
    @Test(dependsOnMethods = "gocheckWithSpaceFeedback")
